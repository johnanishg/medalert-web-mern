...
interface ApiService {
    ...
    suspend fun getPatientProfile(@Path("id") id: String): Response<ApiResponse<Patient>>
    ...
    // Adherence Tracking
    @POST("adherence/record/{patientId}/{medicineIndex}")
    ...
    @GET("adherence/history/{patientId}/{medicineIndex}")
